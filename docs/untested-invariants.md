...
`78ae80d2 -> b7e37e3f`, store `9e0561ce -> 0332d7bd`, mailbox
`397f3005 -> 135e8cf7`, index `88fe938b -> 8063f073`, delegate
`0ab16ff6 -> d1f634c4`, each recorded in `legacy/`. Mutation results were
