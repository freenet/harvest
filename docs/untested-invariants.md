...
entity model's commitment. A re-key of every artifact: reputation
`78ae80d2 -> ef73b95c`, store `9e0561ce -> e4b61205`, mailbox
`397f3005 -> fe6ef3a0`, index `88fe938b -> 02b23f7c`, delegate
`0ab16ff6 -> f9483e50`, each outgoing hash recorded in `legacy/` (the new
hashes are after #143's review-round-1 fixes; round 1 reviewed
`b7e37e3f` / `0332d7bd` / `135e8cf7` / `8063f073` / `d1f634c4`, never
published). Mutation results were
